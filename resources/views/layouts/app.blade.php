...
<head>
    ...
    <title>Photodeck</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="Photodeck - A great photo sahring platform">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="//i.imgur.com/QRAUqs9.png">
    <link rel="shortcut icon" href="//i.imgur.com/QRAUqs9.png">
...
<div id="app">
    <div class="content">
        <div class="animated fadeIn justify-content-center row">
